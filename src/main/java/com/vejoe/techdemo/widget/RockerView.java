package com.vejoe.techdemo.widget;
...
public class RockerView extends SurfaceView implements SurfaceHolder.Callback, Runnable{
    ...
    // 固定摇杆背景圆形的X,Y坐标以及半径
    private int RockerCircleX = 200;
    private int RockerCircleY = 200;
    ...
    public interface OnRockerListener {
        void onRocker(int which);
        void onRocker(RockerView rockerView, int which);
    }
}
